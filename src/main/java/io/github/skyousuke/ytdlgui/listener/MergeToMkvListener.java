...
public class MergeToMkvListener extends AwaitingProcessListener {
    ...
    public MergeToMkvListener(MainPageController pageController, Duration totalDuration) {
    ...
    public void onOutput(String message) {
        ...
        if (convertingDuration != null) {
            ...
            String text = String.format(Locale.US, "%s (%.1f%%)",
                    StatusMessage.MERGING_TO_MKV.toString(), percentComplete);
