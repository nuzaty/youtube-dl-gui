...
public class ConvertToMkvListener extends AwaitingProcessListener {
    ...
    public ConvertToMkvListener(MainPageController pageController, Duration totalDuration) {
    ...
    public void onOutput(String message) {
        ...
        if (convertingDuration != null) {
            ...
            String text = String.format(Locale.US, "%s (%.1f%%)",
                    StatusMessage.CONVERTING_TO_MKV.toString(), percentComplete);
